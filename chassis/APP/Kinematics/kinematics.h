...
#define half_width  20.000000f		//底盘半宽
#define half_length  20.000000f		//底盘半长

#define PI 			3.141593f
#define PI2     2*PI
#define RPM2RAD 0.104720f										//转速转角速度		1 rpm = 2pi/60 rad/s 
#define RPM2VEL 0.806342f										//转速转线速度		vel = rpn*pi*D/60  cm/s
#define VEL2RPM 1.240168f										//线速度转转度  //1.240168
#define M2006_REDUCTION_RATIO 36.000000f		//齿轮箱减速比
#define M3508_REDUCTION_RATIO 13.733f		//齿轮箱减速比
