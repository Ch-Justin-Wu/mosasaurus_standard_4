...
float YawGyroPid[7] 	= {0.13f,			0.0f,			0.05f,	10.0f,			0.0f,	 0.16f};  //imu角度环  1.8 
...
float YawSpeedPid[7] 			= {10000.0f,			3100.0f,			0.0f,		17000.0f,			6500.0f,		0.01f,  0.7};    //luounyu 新积分分离
...
float PitchGyroPid[7] = {0.15f,			0.0f,			0.0f,		50.0f,			0.0f		,0.0f};
